      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-white border border-[#E8E8E6] rounded-2xl p-6 shadow-sm">
            <h2 className="text-base font-display font-semibold text-[#111111] mb-3">
            ...
            <form onSubmit={handleScoreCalculate} className="space-y-4">
              <div>
                <textarea
                  ...
                  className="w-full h-80 p-4 rounded-lg text-sm border border-[#E8E8E6] focus:border-[#111111] outline-none text-[#111111] placeholder-[#6B6B6B]/40 bg-white resize-none leading-relaxed"
                  disabled={scoring}
                />
                <div className="flex justify-between items-center text-xs text-[#6B6B6B] mt-2 px-1">
